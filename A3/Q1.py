...
S_list = []
S_,class_labels_b = partA(k=25, km_num_iterations = 30, gmm_num_iterations = 10,flag_diag=0)
S_list.append(S_)
S_,class_labels_b = partA(k=25, km_num_iterations = 30, gmm_num_iterations = 10,flag_diag=1)
S_list.append(S_)
